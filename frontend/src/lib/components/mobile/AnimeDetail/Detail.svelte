...
>
	<table
		...
		style="max-width:100vw; table-layout: auto; word-break: break-word;"
	>
		<tbody>
	...
	<!-- <table class="w-full bg-black/30" style="max-width:100vw; table-layout: auto; word-break: break-word;">
		<tbody>
