    ...
    >
      ...
      <div class="p-6">
        <div class="space-y-4">
          ...
          >
            Enjoying our platform? Your <span class="text-fuchsia-500 font-bold">donation</span> helps us continue development
          ...
          <div class="grid grid-cols-2 gap-3 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="flex items-center justify-center gap-2 rounded-lg py-2.5 px-4 text-purple-500 text-sm font-medium transition-all duration-200 hover:scale-[1.02]"
          ...
          <p class="text-xs" style="color: hsl(var(--muted-foreground))">
            Every contribution makes a <span class="text-cyan-500 font-bold">difference</span>. Thank you for your support!
          </p>
        </div>
      </div>
    </div>
