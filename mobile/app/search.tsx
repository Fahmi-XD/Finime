...
import { View, Text, Image, TextInput, ScrollView, TouchableOpacity, Pressable, SafeAreaView, ToastAndroid } from "react-native";
...
const SearchScreen = () => {
  ...
  return (
    <>
      <View style={{ position: "absolute", top: 0, left: 0, right: 0, padding: 16, paddingTop: 60, backgroundColor: "black", zIndex: 10 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", position: "relative" }} onPress={() => navigation.goBack()}>
      ...
      <ScrollView style={{ flex: 1, backgroundColor: "black" }} contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 120 }}>
        <SafeAreaView>
          <View style={{ marginTop: 60 }}>
            <Text style={{ fontSize: 20, fontWeight: "600", color: "white", marginBottom: 16 }}>Relevan result</Text>

            <View>
              <Image source={require("@/assets/images/konosuba.jpg")} style={{ height: 200, width: "100%", borderRadius: 16 }} resizeMode="cover" />
              <View style={{ marginTop: 12 }}>
                <Text style={{ fontSize: 16, fontWeight: "600", color: "white" }}>KonoSuba: God's Blessing on This Wonderful World! 3</Text>
