<script lang="ts">
  ...
  import type { IQuerySearch } from "./proxy+page";
  import type { ISearchResponse, GenreList } from "$/types/animeSearch";
  import type { IAnimeDetail } from "$/types/animeType";
  import AnimeHeroSearchLayout from "$/components/layouts/AnimeHeroSearchLayout.svelte";
  import MangaHeroSearchLayout from "$/components/layouts/MangaHeroSearchLayout.svelte";
