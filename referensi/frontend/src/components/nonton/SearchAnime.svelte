<script lang="ts">
  ...
  import ResultSearchAnime from "$components/nonton/layouts/ResultSearchAnime.svelte";
...
<div class="bg-[hsl(var(--background))]">
  <div class="flex justify-center items-center pt-20">
    <Search handleFilterIsOpen={() => {}} placeholder="Search anime..." onSearch={(e) => handleSearch(e)} />
  </div>
